...
RUTAS = {
    'CBLOF': {
        'metricas_csv': DIRECTORIO_BASE / 'CBLOF' / 'metricas_CBLOF' / 'metrics.csv',
        'metricas_txt': DIRECTORIO_BASE / 'CBLOF' / 'metricas_CBLOF' / 'metrics.txt',
        'scores_csv': DIRECTORIO_BASE / 'CBLOF' / 'metricas_CBLOF' / 'anomaly_scores.csv',
        'anomalias_csv': DIRECTORIO_BASE / 'CBLOF' / 'metricas_CBLOF' / 'anomalies.csv',
        'grafica_scores': DIRECTORIO_BASE / 'CBLOF' / 'graficas_CBLOF' / 'anomaly_scores.png',
        'grafica_3d': DIRECTORIO_BASE / 'CBLOF' / 'graficas_CBLOF' / 'anomalies_3d.png',
    },
    'Isolation Forest': {
...
def cargar_metricas() -> Tuple[pd.DataFrame, pd.DataFrame]:
    ...
    if not validar_columnas_metricas(metricas_cblof, 'CBLOF'):
        print("[ERROR] El archivo metrics.csv de CBLOF no tiene el formato esperado.")
        exit(1)
    
    if not validar_columnas_metricas(metricas_iforest, 'Isolation Forest'):
        print("[ERROR] El archivo metrics.csv de Isolation Forest no tiene el formato esperado.")
        exit(1)
